...
(function () {
  ...
  var I18N = {
    ...
    en: {
      ...
      'mirrors.title': '10 built-in mirror sites',
  ...
  var FEATURES = [
    ...
    { icon: '🪞', zh: { title: '多镜像支持', desc: '内置 10 个镜像站，覆盖前缀代理 / 域名替换 / 路径前缀等多种策略。' }, en: { title: 'Multi-mirror', desc: '10 built-in mirrors covering prefix-proxy / domain-swap / path-prefix strategies.' } },
  ...
  var USAGE = [
    ...
    { tag: { zh: '指定', en: 'Specified' }, cls: '', title: { zh: '指定镜像', en: 'Specify a mirror' }, desc: { zh: '用 <code>--mirror</code> 显式指定镜像 key。', en: 'Use <code>--mirror</code> to set the mirror key explicitly.' }, cmd: 'fast-clone --mirror kkgithub https://github.com/user/repo' },
  ...
  var TERMINAL = {
    zh: [
      ...
      { c: 'term-muted', t: '  -> 测速 10 个镜像...' },
      { c: 'term-green', t: '  github-ur1        33ms' },
      { c: '', t: '  gh-proxy-org      48ms' },
      { c: '', t: '  gh-proxy-v4       43ms' },
      { c: 'term-muted', t: '  ...' },
      { c: 'term-cyan', t: '  -> 选定: github.ur1.fun' },
      { c: '', t: '$ git clone --progress https://github.ur1.fun/https://github.com/user/repo.git' },
      { c: 'term-muted', t: '  remote: Enumerating objects: 1248, done.' },
      { c: 'term-muted', t: '  接收对象中 48.2 MiB  @ 12.4 MiB/s' },
      { c: 'term-green', t: '  OK 克隆成功: github.ur1.fun' },
      { c: 'term-green', t: "  OK remote 'origin' -> https://github.com/user/repo.git" }
    ],
    en: [
      { c: '', t: '$ fast-clone --fastest https://github.com/user/repo' },
      { c: 'term-muted', t: '  -> detecting network: IPv4 ✓  IPv6 ✓' },
      { c: 'term-muted', t: '  -> benchmarking 10 mirrors...' },
      { c: 'term-green', t: '  github-ur1        33ms' },
      { c: '', t: '  gh-proxy-org      48ms' },
      { c: '', t: '  gh-proxy-v4       43ms' },
      { c: 'term-muted', t: '  ...' },
      { c: 'term-cyan', t: '  -> selected: github.ur1.fun' },
      { c: '', t: '$ git clone --progress https://github.ur1.fun/https://github.com/user/repo.git' },
      { c: 'term-muted', t: '  remote: Enumerating objects: 1248, done.' },
      { c: 'term-muted', t: '  receiving objects 48.2 MiB  @ 12.4 MiB/s' },
      { c: 'term-green', t: '  OK cloned: github.ur1.fun' },
      { c: 'term-green', t: "  OK remote 'origin' -> https://github.com/user/repo.git" }
    ]
  };
